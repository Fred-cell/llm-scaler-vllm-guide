...
本目录已整理以下材料，便于随邮件一并发送：

| 类型 | 文件 |
|---|---|
| 邮件正文 | `to_Intel_mail.md` |
| 更新后 PP/TP 对比报告 | `qwen36_35b_fp8_b70_kernel1009_pcmacros_perf_compare_20260604.md` |
| PP=2 完整测试报告 | `qwen36_35b_fp8_b70_pp2_kernel1009_pcmacros_perf_report_20260604.md` |
| TP=2 完整测试报告 | `qwen36_35b_fp8_b70_tp2_kernel1009_pcmacros_perf_report_20260604.md` |
| PP=2 test-model stdout 日志 | `qwen36_35b_fp8_b70_pp2_kernel1009_pcmacros_perf_stdout_20260604.log` |
| TP=2 test-model stdout 日志 | `qwen36_35b_fp8_b70_tp2_kernel1009_pcmacros_perf_stdout_20260604.log` |
| PP=2 启动脚本 | `start_qwen36_pp2_nomax_pcmacros.sh` |
| TP=2 启动脚本 | `start_qwen36_tp2_nomax_pcmacros.sh` |
| PP=2 启动日志 | `docker_start_pp2_kernel1009_pcmacros_20260604_203617.log` |
| TP=2 启动日志 | `docker_start_tp2_kernel1009_pcmacros_20260604_204345.log` |
| 当前容器 inspect | `docker_inspect_llm-scaler-qwen36-b70.json` |
| 当前容器 docker logs | `docker_logs_llm-scaler-qwen36-b70_tail1000.log` |
| xpu-smi / sycl-ls / 系统信息快照 | `server_xpu_smi_system_snapshot_20260605.txt` |
| 驱动更新报告 | `b70_driver_update_26.18.8.2_kernel_6.17.0-1009_20260604.md` |
| 驱动安装修复日志 | `b70_driver_install_repair_26.18.8.2_20260604.log` |
| no enforce-eager 排查报告 | `qwen36_35b_fp8_b70_noeager_start_check_20260604.md` |
| no enforce-eager 失败日志 | `qwen36_35b_fp8_b70_tp2_noeager_start_failure_20260604.log` |
